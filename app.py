...
def init() -> tuple:
    ...
    parser.add_argument('--preload_data', default=False,
                        help='use preload data or download data from world_bank/oecd via api')
    parser.add_argument('--use_postgres', default=False,
                        help='Use or not postgres for storing data')
    parser.add_argument('--postgres_username', type=str, default=None,
    ...
    parser.add_argument('--use_ollama', default=False,
    ...
    parser.add_argument('--web_ui_port', type=int, default=None,
